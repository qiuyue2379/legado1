...
import io.qiuyue.app.help.storage.ImportOldData
import io.qiuyue.app.help.storage.Restore
import io.qiuyue.app.lib.dialogs.alert
import io.qiuyue.app.lib.permission.Permissions
import io.qiuyue.app.lib.permission.PermissionsCompat
...
class BackupConfigFragment : BasePreferenceFragment(),
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<io.qiuyue.app.ui.widget.prefs.Preference>("web_dav_restore")
