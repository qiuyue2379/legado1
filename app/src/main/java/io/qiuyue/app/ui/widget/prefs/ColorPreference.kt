package io.qiuyue.app.ui.widget.prefs
...
class ColorPreference(context: Context, attrs: AttributeSet) : Preference(context, attrs),
    ...
    init {
        isPersistent = true
        layoutResource = io.qiuyue.app.R.layout.view_preference
    ...
    override fun onBindViewHolder(holder: PreferenceViewHolder) {
        val v = io.qiuyue.app.ui.widget.prefs.Preference.bindView<ColorPanelView>(
            context, holder, icon, title, summary, widgetLayoutResource,
            io.qiuyue.app.R.id.cpv_preference_preview_color_panel, 30, 30
        )
